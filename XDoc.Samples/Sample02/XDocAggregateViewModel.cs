...
namespace XDoc.Samples.Sample02
{
  public class XDocAggregateViewModel : CommonBase
  {
    ...
    public void Minimum()
    {
      ...
      query += "     not(. >=../preceding-sibling::OrderDetail/LineTotal)";  // Grab the previous line total and compare against current
      query += " and not(. >=../following-sibling::OrderDetail/LineTotal)]";  // test if the previous line total greater than or equal to  the following line total
